...
DSP_LIB = STM32F10x_DSP_Lib
FREERTOS = src/freertos

# Please add all the appropriate src files, (*.o) targets
C_SRCS = delay.c usart.c eeprom.c main.c system_stm32f10x.c crc16.c 
# FreeRTOS
...
ASM_SRCS += startup_stm32f10x_md.s cr4_fft_256_stm32.s fir_stm32.s
...
$(PROJ_NAME).elf: $(OBJECTS) Makefile
	...
	@echo
	@echo $(value STARTUP)
	@$(CC) $(OBJECTS) $(CFLAGS) $(LDFLAGS) -o $@ -L$(STD_PERIPH_LIB) -lstm32f1 -lm -L$(LDSCRIPT_INC)
